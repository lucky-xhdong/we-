            ...
            <div class="bor-a h-o inspect-new-panel">
                <!--表格左厕 start-->
                  <?php if(isset($article->inspect_record_id)):?>
                  		<?php echo form_open('inspect/addrecord/'.$article->inspect_record_id,'id="ipregnantform"');?> 
                  <?php else:?>
                   	<?php echo form_open('inspect/addrecord/','id="ipregnantform"');?> 
                   <?php endif;?> 
                        <div class="cf-h"></div>
                <div class="col-sm-8 h-o">
                    ...
                    <span>孕周:</span>
                    孕 <select name="week_id">
                        <?php foreach($weeks as $week):?>
                        <?php if($week == $article->week_id):?>
