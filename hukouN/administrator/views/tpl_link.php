...
<div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <section class="main-carema-list">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <a <?php if ($controller == 'adminlink' && $action == 'add') echo 'class="active"'; else echo 'class=""'; ?> href="javascript:;">友情链接</a>
                    </li>
                </ul>
            </div>
            <nav class="nav-section">
                <ul>
                    <li><?=anchor('friendlink/index/','友情链接列表')?></li>
                    <li><?=anchor('friendlink/add/','添加友情链接', 'class="current"')?></li>
                </ul>
            </nav>
            <!--右厕内容 start-->
            <div class="carema-lists">
                <div class="inspect-new-panel">
                    ...
                    <?php if (isset($article->id)): ?>
                        <?php echo form_open('friendlink/addcontent/' . $article->id); ?>
                    <?php else: ?>
                        <?php echo form_open('friendlink/addcontent/'); ?>
                    <?php endif; ?>
                    <div class="cf-h"></div>
    ...
    <?php echo form_open('friendlink/addimage', 'name="imageform" id="imageform" enctype="multipart/form-data"'); ?>
