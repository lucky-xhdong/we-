			...
			<div class="header">
				<div class="header-inner clearfix">
					<a class="brand pull-left" href="javascript:void(0)">
						<span class="site-title" title="<?=$article->title?>"><?=$article->title?></span>
                    </a>
                                ...
                                <div class="page-header">
									<div class="dis-e ver-a-b li-ul-pad li-com-fl li-inline it-label">
                                        <ul>
                                            ...
                                            <li><a href="javascript:void(0)" title="<?=$tag->name?>" class="text-b label-com label-act-a"><?=$tag->name?>
                                                </a>
                                            </li>
                                            <?php endforeach;?>
                                            <li>
                                    			<span class="dis-e ver-a-b color-b span-time-a"><?=$article->publishtime?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                
                                <p class="img-com text-b article-content">
                                <?php if(!empty($article->urls)):?>
                                		<img src="<?=pictureurl2($uid).$article->urls?>">
                                   <?php endif;?>       
                                	<span></span>
                                </p>
