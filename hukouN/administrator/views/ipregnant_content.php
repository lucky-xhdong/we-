    ...
    <!--左厕菜单 end--> 
		...
		<div class="col-md-12 col-sm-12">
            <div class="bor-a h-o inspect-new-panel">
                <!--表格左厕 start-->
				<?php if(isset($article->content_id)):?>
                        <?php echo form_open('ipregnant_content/addcontent/'.$article->content_id);?> 
                <?php else:?>
                        <?php echo form_open('ipregnant_content/addcontent/');?> 
                <?php endif;?>
                <div class="cf-h"></div>
      ...
      <?php echo form_open('ipregnant_content/addimage','name="imageform" id="imageform" enctype="multipart/form-data"');?>  
