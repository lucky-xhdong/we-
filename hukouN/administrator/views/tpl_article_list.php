            ...
            <!--左厕菜单 end-->
              ...
              <section class="main-carema-list">
                  ...
                  <nav class="nav-section">
                      <ul>
                          <li><?=anchor('articles/index/'.$categoryid,'文章列表','class="current"')?></li>
                          <li><?=anchor('articles/add/'.$categoryid,'添加文章')?></li>
                      </ul>
                  </nav>
                      ...
                      <div class="li-table li-width-a li-ul-pad bor-a li-manage">
                          <ul>
                              <li>
                                  ...
                                  <div class="dis-e ver-a-b it-tab-caption"> <span>访问量</span> </div>
                              ...
                              <?php $i = 0; foreach($articles as $article):?>
                                  <li id="article-<?=$article->id?>">
                                      ...
                                      <div class="dis-e ver-a-b it-article">
                                          <?=anchor('articles/add/'.$article->catid.'/'.$article->id,$article->title)?>
                                      </div>
                                      <!--简介-->
                                      <div class="dis-e ver-a-b it-check">
                                          <?=anchor('articles/add/'.$article->catid.'/'.$article->id,$article->hits)?>
                                      </div>
                                      <!--简介-->
                                      <div class="dis-e ver-a-b it-check">
                                          <?=anchor('articles/add/'.$article->catid.'/'.$article->id,$article->create_time)?>
                                      </div>
                                      <!--删除文章按钮-->
                                      <div class="dis-e ver-a-b it-id">
