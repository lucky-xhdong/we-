...
<div class="container login dis-d bor-a ip-user-list">
    ...
    <div class="col-md-5 col-lg-5">
      <?php echo form_open('users/editorlist','name="userform" id="userform"');?> 
        <div class="input-group">
          <input type="text" class="fl form-control" id="user-search-control" name="key" value="<?php if(isset($key)) echo $key;?>" placeholder="用户名/手机号/email">
    ...
    <div class="mar-l-b col-md-5 col-lg-5">
		  <?=anchor('users/editorlist','重置','class="btn btn-default btn-user-reset"')?>
    </div>
            <div class="cf-e"></div>
       <!--右厕内容 start-->
       <div class="col-md-10">
