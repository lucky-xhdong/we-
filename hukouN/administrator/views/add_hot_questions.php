    ...
    <!--左厕菜单 end--> 
		...
		<div class="col-md-12 col-sm-12">
            <div class="bor-a h-o inspect-new-panel">
                <!--表格左厕 start-->
                    <?php if(isset($article->question_id)):?>
                   		
                        <?php echo form_open('hot_questions/addrecord/'.$article->question_id,'id="ipregnantform"');?> 
                    <?php else:?>
                    	<?php echo form_open('hot_questions/addrecord/','id="ipregnantform"');?> 
                    <?php endif;?>
                        <div class="cf-h"></div>
                <div class="col-sm-8 h-o">
                    ...
                    <!--题目-->
                     <div class="cf-h"></div>
                    <span>答案:</span>
                    <textarea id="body" name="answer" >
                        <?php if(isset($article)) echo $article->answer;?>
                     </textarea>
