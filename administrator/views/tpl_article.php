                                ...
                                <div class="dis-table-cell cover-image">
                                    ...
                                    <figure class="dis-c pad-h-b" id="coverimage">
                                            ...
                                            <ul class="clear courseDetail-imgs " id="picture_file_ids">
                                                ...
                                                <li>
                                                    <img src="<?=$picture?>" alt="">
                                                    <i class="fa fa-close removePicture" aria-hidden="true" data-id="<?=$picture_url?>"></i>
                                                </li>
                                                <?php endforeach;;?>
                                                <?php endif; ?>
                                            </ul>
            ...
            $('#file').on('change', function () {
                $("#imageform").ajaxForm({
                    ...
                    success: function (data) {
                             var string = '<li> <img src="<?=base_url() . pictureurl(0)?>' + data.filename + '" alt=""> <i class="fa fa-close removePicture" aria-hidden="true" data-id="'+data.filename+'"></i> </li>';
