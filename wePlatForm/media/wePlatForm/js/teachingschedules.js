...
var tItem = [
    ...
    },
    {
        ...
        lockDisplay: true,
        renderer: function (val,item) {
            return '<a href="javascript:;" class="btn-normal edit">编辑</a> <a href="javascript:;" class="btn-normal view">任务列表</a>';
...
var mmg = $('#mmGrid').mmGrid({
    ...
    height: 'auto',
    cols: tItem,
    url: base_url+'/teachingschedules/getTeachingScheduleList',
    method: 'get',
    params:{
    ...
    if($(e.target).is('.btn-info, .btnPrice')){
        ...
        e.stopPropagation(); //阻止事件冒泡
        userItem = item;
        window.location.href = base_url+'/teachingscheduletasks/index/'+item.id
