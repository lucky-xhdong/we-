...
var EducationPlanItem = [
    ...
    },
    {
        ...
        lockDisplay: true,
        renderer: function (val,item) {
            return ' <a href="javascript:;" class="btn-normal btn-view view">督课表</a> ';
...
var mmgEducationPlanDocument = $('#region_education_plan').mmGrid({
        ...
        url: base_url+'/serviceaudit/getRegionServiceEducationPlanList/'+plan_id,
        method: 'get',
        params:{
        ...
        if($(e.target).is('.btn-info, .btnPrice')){
            ...
            e.stopPropagation(); //阻止事件冒泡
            userItem = item;
            window.location.href = base_url+'/serviceaudit/supervisecourses/'+item.id
