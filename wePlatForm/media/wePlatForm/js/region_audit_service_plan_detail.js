...
function getServicePlanmmgDocument(){
    mmgservicepLANDocument = $('#region_service_plan').mmGrid({
        ...
        url: base_url+'/serviceaudit/getRegionServicePlanList/'+region_id,
        method: 'get',
        params:{
        ...
        if($(e.target).is('.btn-info, .btnPrice')){
            ...
            $.ajax({
                type: "POST",
                async:false,
                url: base_url+'/serviceaudit/addRegionServicePlan',
                data: {
                    id:item.id,
            ...
            console.log($(e.target));
            e.stopPropagation(); //阻止事件冒泡
            window.location.href = base_url+'/serviceaudit/businessPlan/'+item.id;
        }
