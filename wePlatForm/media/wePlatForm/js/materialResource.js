...
var tItem = [
    {
        ...
        renderer:function(val,item){
            if(val.type == "image"){
                return '<img src="'+val.url+'" width="100px;" />';
    ...
    },
    {
        ...
        lockDisplay: true,
        renderer: function (val) {
            return ' <a class="btn-normal btn-preview">预览</a> <a href="javascript:;" class="btn-normal btn-view">查看</a> <a href="javascript:;"  class="btn-normal btn-delete">删除</a>'
        }
    }
