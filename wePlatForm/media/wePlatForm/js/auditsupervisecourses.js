...
var businessItem = [
    ...
    },
    {
        ...
        lockDisplay: true,
        renderer: function (val,item) {
            return '<a href="javascript:;" class="btn-normal view"></i>查看</a>';
...
mmg = $('#region_education_plan').mmGrid({
        ...
        height: 'auto',
        cols: businessItem,
        url: base_url+'/serviceaudit/getSupervisecoursesList/'+region_education_plan_id,
        method: 'get',
        params:{
        ...
        if($(e.target).is('.btn-info, .btnPrice')){
            ...
            e.stopPropagation(); //阻止事件冒泡
            userItem = item;
            window.location.href = base_url+'/serviceaudit/supervisecourses_detail/'+item.id
