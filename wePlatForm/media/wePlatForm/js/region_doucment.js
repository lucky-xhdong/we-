...
var mmgDocument = null;

function getmmgDocument(){
     mmgDocument = $('#region_document').mmGrid({
        indexCol: true,
        indexColWidth: 30,
        checkCol: true,
        multiSelect: false,
        ...
        height: 'auto',
        cols: tItem,
        url: base_url+'/regions/getfilelist/'+region_id+'/region_document',
        method: 'get',
        params:{
        ...
        nowrap: true,
        plugins : [
            $('#paginator_region_document').mmPaginator({limitList: [10,20,30,50]})
        ]
