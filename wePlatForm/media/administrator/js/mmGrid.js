    ...
    MMGrid.prototype = {
        ...
        , _initEvents: function(){
            ...
            $body.on('click','td',function(e){
                ...
                that.$body.triggerHandler(event, [$.data($this.parent()[0], 'item'), $this.parent().index(), $this.index(),check]);
           ...
           // var $body = this.$body;
            $body.on('click','tr > td .mmg-check',function(e){
                ...
                var event = jQuery.Event("cellSelectedCheck");
                event.target = e.target;
                that.$body.triggerHandler(event, [$.data($this.parent()[0], 'item'), $this.parent().index(), $this.index(),check]);
            ...
            $body.on('mouseover','.item',function(e){
                var $this = $(this).parents("td");
                var event = jQuery.Event("cellMouseover");
                event.target = e.target;
        ...
        , _setColsWidth: function(){
            ...
            for(var colIndex=0; colIndex<$ths.length; colIndex++){
                ...
                if(col.align){
                    ...
                    styleText.push('box-sizing:content-box;');
                }
                if(col.hidden){
            ...
            console.log($head.width()+'$head.width()');
