...
(function() {
  var BuilderView, EditFieldView, Formbuilder, FormbuilderCollection, FormbuilderModel, ViewFieldView, _ref, _ref1, _ref2, _ref3, _ref4, __hasProp = {}.hasOwnProperty, __extends = function(
      child, parent) {
  ...
  FormbuilderModel = (function(_super) {
    ...
    FormbuilderModel.prototype.is_input = function() {
      return Formbuilder.inputFields[this
          .get(Formbuilder.options.mappings.FIELD_TYPE)] != null;
    };
  ...
  FormbuilderCollection = (function(_super) {
    ...
    function FormbuilderCollection() {
      _ref1 = FormbuilderCollection.__super__.constructor
  ...
  ViewFieldView = (function(_super) {
    ...
    ViewFieldView.prototype.render = function() {
      this.$el.addClass(
          'response-field-'
              + this.model.get(Formbuilder.options.mappings.FIELD_TYPE)).data(
          'cid', this.model.cid).html(
          Formbuilder.templates["view/base"
      ...
      bootbox.confirm("确定删除？",
          function(result) {
            if (result) {
              ...
              $el = $(e.currentTarget);
              index = _this.$el.find(".js-remove-option").index($el);
              options = _this.model.get(Formbuilder.options.mappings.OPTIONS);
              options.splice(index, 1);
              _this.model.set(Formbuilder.options.mappings.OPTIONS, options);
              _this.model.trigger("change:"
                  + Formbuilder.options.mappings.OPTIONS);
  ...
  BuilderView = (function(_super) {
    ...
    BuilderView.prototype.bindSaveEvent = function() {
      ...
      this.saveFormButton.hide();
      this.saveFormButton.attr('disabled', true).text(
          Formbuilder.options.dict.ALL_CHANGES_SAVED);
        ...
        stop : function(e, ui) {
          ...
          if (ui.item.data('field-type')) {
            rf = _this.collection.create(Formbuilder.helpers
                .defaultFieldAttrs(ui.item.data('field-type')), {
              $replaceEl : ui.item
            });
    ...
    BuilderView.prototype.hideShowNoResponseFields = function() {
      return this.$el.find(".fb-no-response-fields")[this.collection.length > 0 ? 'hide'
          : 'show']();
    };
    ...
    BuilderView.prototype.createAndShowEditView = function(model) {
      ...
      $responseFieldEl.addClass('editing').siblings('.fb-field-wrapper')
          .removeClass('editing');
      if (this.editView) {
    ...
    BuilderView.prototype.scrollLeftWrapper = function($responseFieldEl) {
      ...
      return $.scrollWindowTo((this.$el.offset().top + $responseFieldEl
          .offset().top)
          - this.$responseFields.offset().top, 200, function() {
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs : function(field_type) {
        var attrs, _base;
        attrs = {};
        attrs[Formbuilder.options.mappings.LABEL] = Formbuilder.fields[field_type].default_title
            || gettext("无标题");
        attrs[Formbuilder.options.mappings.FIELD_TYPE] = field_type;
        attrs[Formbuilder.options.mappings.REQUIRED] = true;
        attrs['field_options'] = {};
        return (typeof (_base = Formbuilder.fields[field_type]).defaultAttributes === "function" ? _base
    ...
    function Formbuilder(opts) {
      ...
      this.getForm = function() {
        return this.mainView.collection.toJSON();
      }
    }
...
// <span class='zip'>\n <input type='text' />\n <label>Zipcode</label>\n
// </span>\n\n <span class='country'>\n <select><option>United
// States</option></select>\n <label>Country</label>\n </span>\n</div>",
// edit : "",
// addButton : "<span class=\"symbol\"><span class=\"fa fa-home\"></span></span>
// "
// + gettext("Address")
// });
//
...
(function() {
  Formbuilder
      .registerField(
          ...
          {
            order : 10,
            title : "用于多选项时，如：爱好，多选题等",
            default_title : "复选框",
            view : "<% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n  <div>\n    <label class='fb-option'>\n      <input type='checkbox' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n  </div>\n<% } %>\n\n<% if (rf.get(Formbuilder.options.mappings.INCLUDE_OTHER)) { %>\n  <div class='other-option'>\n    <label class='fb-option'>\n      <input type='checkbox' />\n      其他\n    </label>\n\n    <input type='text' />\n  </div>\n<% } %>",
            edit : "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
            addButton : "<span class=\"symbol\" data-toggle=\"tooltip\"><span class=\"fa fa-square-o\"></span></span> "
                + gettext("复选框"),
...
(function() {
  Formbuilder
      .registerField(
          ...
          {
            order : 20,
            title : "用于选择一个日期，如，生日等",
            default_title : "日期",
            //view : "<div class='input-line'>\n  <span class='month'>\n    <input type=\"text\" />\n    <label>MM</label>\n  </span>\n\n  <span class='above-line'>/</span>\n\n  <span class='day'>\n    <input type=\"text\" />\n    <label>DD</label>\n  </span>\n\n  <span class='above-line'>/</span>\n\n  <span class='year'>\n    <input type=\"text\" />\n    <label>YYYY</label>\n  </span>\n</div>",
            view : "<input type='text' placeholder='YYYY-MM-DD' />",
            edit : "",
            addButton : "<span class=\"symbol\"><span class=\"fa fa-calendar\"></span></span> "
                + gettext("日期")
          });
...
(function() {
  Formbuilder
      .registerField(
          ...
          {
            order : 40,
            title : "用于需要填写电子邮箱时，如 E-Mail等",
            default_title : "电子邮件",
            view : "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />",
            edit : "",
            addButton : "<span class=\"symbol\"><span class=\"fa fa-envelope-o\"></span></span> "
                + gettext("电子邮件")
          });
...
(function() {
  Formbuilder
      .registerField(
          ...
          {
            order : 30,
            title : "用于填写数字时，如：年龄，体重等",
            default_title : "数字",
            view : "<input type='text' />\n<% if (units = rf.get(Formbuilder.options.mappings.UNITS)) { %>\n  <%= units %>\n<% } %>",
            edit : "<%= Formbuilder.templates['edit/min_max']() %>\n<%= Formbuilder.templates['edit/units']() %>\n<%= Formbuilder.templates['edit/integer_only']() %>",
            addButton : "<span class=\"symbol\"><span class=\"fa fa-number\">123</span></span> "
                + gettext("数字")
          });
...
// />\n <label>Cents</label>\n </span>\n</div>",
// edit : "",
// addButton : "<span class=\"symbol\"><span class=\"fa fa-usd\"></span></span>
// "
// + gettext("Price")
// });
//
...
(function() {
  Formbuilder
      .registerField(
          ...
          {
            order : 15,
            title : "用于单选项时，如：性别，单选题等",
            default_title : "单选",
            view : "<% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n  <div>\n    <label class='fb-option'>\n      <input type='radio' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n  </div>\n<% } %>\n\n<% if (rf.get(Formbuilder.options.mappings.INCLUDE_OTHER)) { %>\n  <div class='other-option'>\n    <label class='fb-option'>\n      <input type='radio' />\n      其他\n    </label>\n\n    <input type='text' />\n  </div>\n<% } %>",
            edit : "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
            addButton : "<span class=\"symbol\"><span class=\"fa fa-circle-o\"></span></span> "
                + gettext("单选"),
            defaultAttributes : function(attrs) {
              attrs.field_options.options = [ {
                label : "",
...
(function() {
  Formbuilder
      .registerField(
          ...
          {
            order : 0,
            title : "用于需要分隔及说明性文字时，如备注等",
            default_title : "文字描述",
            type : 'non_input',
            view : "<label class='section-name'><%= rf.get(Formbuilder.options.mappings.LABEL) %></label>\n<p><%= rf.get(Formbuilder.options.mappings.DESCRIPTION) %></p>",
            edit : "<div class='fb-edit-section-header'>"
                + gettext("标签")
                + "</div>\n<input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.LABEL %>' />\n<textarea data-rv-input='model.<%= Formbuilder.options.mappings.DESCRIPTION %>'\n  placeholder='"
                + gettext("增加详细描述") + "'></textarea>",
            addButton : "<span class='symbol'><span class='fa fa-minus'></span></span> "
                + gettext("文字描述")
          });
...
(function() {
  Formbuilder
      .registerField(
          ...
          {
            order : 0,
            title : "用于需要输入单行文字时，如：姓名等",
            default_title : "文本框",
            view : "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />",
            edit : "<%= Formbuilder.templates['edit/size']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>",
            addButton : "<span class='symbol'><span class='fa fa-font'></span></span> "
                + gettext("文本框"),
            defaultAttributes : function(attrs) {
              attrs.field_options.size = 'small';
              return attrs;
...
// edit : "",
// addButton : "<span class=\"symbol\"><span class=\"fa fa-link\"></span></span>
// "
// + gettext("Website")
// });
//
...
this["Formbuilder"]["templates"]["edit/base"] = function(obj) {
  ...
  with (obj) {
    __p += ((__t = (Formbuilder.templates['edit/base_header']())) == null ? ''
        : __t)
        + '\n'
        + ((__t = (Formbuilder.templates['edit/common']())) == null ? '' : __t)
        + '\n'
        + ((__t = (Formbuilder.fields[rf
            .get(Formbuilder.options.mappings.FIELD_TYPE)].edit({
          rf : rf
        }))) == null ? '' : __t) + '\n';
...
this["Formbuilder"]["templates"]["edit/base_header"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class=\'fb-field-label\' style=\'display:none\'>\n  <span data-rv-text="model.'
...
this["Formbuilder"]["templates"]["edit/common"] = function(obj) {
  ...
  with (obj) {
    __p += '<div class=\'fb-edit-section-header\'>'
        ...
        + ((__t = (Formbuilder.templates['edit/label_description']())) == null ? ''
            : __t)
    ...
    // + gettext("Input Name")
    // + '</div>\n\n<div class=\'fb-common-wrapper\'>\n <div
    // class=\'fb-label-inputname\'>\n '
    // + ((__t = (Formbuilder.templates['edit/inputname']())) == null ? ''
    // : __t);
  }
  return __p
};
...
this["Formbuilder"]["templates"]["edit/inputname"] = function(obj) {
  obj || (obj = {});
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<input type=\'text\' data-rv-input=\'model.'
        + ((__t = (Formbuilder.options.mappings.INPUTNAME)) == null ? '' : __t)
        + '\' />';
...
this["Formbuilder"]["templates"]["edit/min_max"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class=\'fb-edit-section-header\'>' + gettext("最小/最大")
        + '</div>\n\n' + gettext("大于")
  ...
  with (obj) {
    __p += '<div class=\'fb-edit-section-header\'>'
        ...
        + ((__t = (Formbuilder.options.mappings.LENGTH_UNITS)) == null ? ''
            : __t) + '" style="width: auto;">\n  <option value="characters">'
        + gettext("文字") + '</option>\n  <option value="words">' + gettext("词")
        + '</option>\n</select>\n';
...
this["Formbuilder"]["templates"]["edit/size"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class=\'fb-edit-section-header\'>' + gettext("尺寸")
        + '</div>\n<select data-rv-value="model.'
        + ((__t = (Formbuilder.options.mappings.SIZE)) == null ? '' : __t)
        + '">\n  <option value="small">' + gettext("小")
        + '</option>\n  <option value="medium">' + gettext("中")
        + '</option>\n  <option value="large">' + gettext("大")
        + '</option>\n</select>\n';
...
this["Formbuilder"]["templates"]["page"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += ((__t = (Formbuilder.templates['partials/save_button']())) == null ? ''
        : __t)
        + '\n'
        + ((__t = (Formbuilder.templates['partials/left_side']())) == null ? ''
            : __t)
        + '\n'
        + ((__t = (Formbuilder.templates['partials/right_side']())) == null ? ''
            : __t) + '\n<div class=\'fb-clear\'></div>';
...
this["Formbuilder"]["templates"]["partials/add_field"] = function(obj) {
  ...
  with (obj) {
    ...
    _.each(_.sortBy(Formbuilder.inputFields, 'order'), function(f) {
      ;
      __p += '\n        <a data-field-type="'
          + ((__t = (f.field_type)) == null ? '' : __t) + '"  title="'
          + ((__t = (f.title)) == null ? '' : __t) + '"  class="'
          + ((__t = (Formbuilder.options.BUTTON_CLASS)) == null ? '' : __t)
...
this["Formbuilder"]["templates"]["partials/left_side"] = function(obj) {
  ...
  with (obj) {
    __p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>'
        ...
        + ((__t = (Formbuilder.templates['partials/add_field']())) == null ? ''
            : __t)
        + '\n    '
        + ((__t = (Formbuilder.templates['partials/edit_field']())) == null ? ''
            : __t) + '\n  </div>\n</div>';
...
this["Formbuilder"]["templates"]["view/base"] = function(obj) {
  ...
  with (obj) {
    __p += '<div class=\'subtemplate-wrapper\'>\n  <div class=\'cover\'></div>\n  '
        ...
        + '\n\n  '
        + ((__t = (Formbuilder.fields[rf
            .get(Formbuilder.options.mappings.FIELD_TYPE)].view({
          rf : rf
        }))) == null ? '' : __t)
        + '\n\n  '
...
this["Formbuilder"]["templates"]["view/description"] = function(obj) {
  ...
  with (obj) {
    __p += '<span class=\'help-block\'>\n  '
        + ((__t = (Formbuilder.helpers.simple_format(rf
            .get(Formbuilder.options.mappings.DESCRIPTION)))) == null ? ''
            : __t) + '\n</span>\n';
...
this["Formbuilder"]["templates"]["view/label"] = function(obj) {
  ...
  with (obj) {
    __p += '<label>\n  <span>'
        + ((__t = (Formbuilder.helpers.simple_format(rf
            .get(Formbuilder.options.mappings.LABEL)))) == null ? '' : __t)
        + '\n  ';
