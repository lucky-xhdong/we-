...
var PDFView = {
  ...
  get supportsFullscreen() {
    ...
    if (document.fullscreenEnabled === false ||
      ...
      // Need to check if the viewer is embedded as well, to prevent issues
		// with
...
// #endif
  ...
  // TODO(mack): This function signature should really be pdfViewOpen(url,
	// args)
...
// #endif
  ...
  /**
	 ...
	 * 
	 * @param {String}
	 *            anchor The anchor hash include the #.
	 */
...
// #endif
  ...
  /**
	 ...
	 * 
	 * @param {String}
	 *            message A message that is human readable.
	 * @param {Object}
	 *            moreInfo (optional) Further information about the error that
	 *            is more technical. Should have a 'message' and optionally a
	 *            'stack' property.
	 */
...
// #endif
    ...
    if (hash.indexOf('=') >= 0) {
      ...
      if ('page' in params) {
        ...
        if ('zoom' in params) {
          ...
          // If the zoom value, it has to get divided by 100. If it is a
			// string,
  ...
  // Generic helper to find out what elements are visible within a scroll
	// pane.
  ...
  /**
	 ...
	 * @this {PDFView}
	 * @param {number}
	 *            mouseScrollDelta The delta value from the mouse event.
	 */
...
var file = window.frameElement.getAttribute("data-file-url");
  // #else
