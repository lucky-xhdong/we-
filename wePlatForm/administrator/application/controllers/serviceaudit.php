...
class Serviceaudit extends CI_Controller {
    ...
    function __construct(){
        ...
        if(!getAdminViewer()->id){
            ...
            if(!in_array("/serviceaudit/business/", $this->permissionsUrls) && !in_array("/serviceaudit/operate/", $this->permissionsUrls) && !in_array("/serviceaudit/education/", $this->permissionsUrls)){
                redirect('error');
            }
        }
    }
    ...
    public function index(){
        if(in_array("/serviceaudit/business/", $this->permissionsUrls)){
            redirect("/serviceaudit/business/");
        }else if(in_array("/serviceaudit/operate/", $this->permissionsUrls)){
            redirect("/serviceaudit/operate/");
        }else if(in_array("/serviceaudit/education/", $this->permissionsUrls)){
            redirect("/serviceaudit/education/");
        }
        $this->load->view('wePlatForm/serviceauditBusiness');
    }
    ...
    public function operate(){
        if(!in_array("/serviceaudit/operate/", $this->permissionsUrls)){
            redirect('error');
        }
        $this->load->view('wePlatForm/serviceauditoperate');
    }

    public function education(){
        if(!in_array("/serviceaudit/education/", $this->permissionsUrls)){
            redirect('error');
        }
        $this->load->view('wePlatForm/serviceauditeducation');
    }
