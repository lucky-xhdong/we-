        ...
        <div class="col-md-9 ct--main-wrapper">
            ...
            <nav class="common-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?=anchorurl("/regions/detail/".$plan_detail->region_id."/business")?>">商务计划</a></li>
...
<!--                                    --><?php //endif;?>
                                ...
                                <div class="col-6 ct--main__basic_item" data-before="发布范围：">
                                    <?php  if($plan_detail->regionInfo->id != 0):?>
                                        <?=$plan_detail->regionInfo->name?>
                                    <?php endif;?>
                                    <?php if($plan_detail->schoolInfo->id != 0):?>
                                        --<?=$plan_detail->schoolInfo->name?>
                                    <?php endif;?>
                                </div>
...
<!--                                <div class="col-6 ct--main__basic_item" data-before="查看附件：">点击下载附件</div>-->
    ...
    <div class="modal fade commonModal" id="region_service_plan_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?=anchorurl('regions/addRegionBusinessServicePlan/'.$plan_detail->id)?>" id="region_service_plan_form" class="form-group needs-validation" novalidate method="post">
                    <div class="modal-body" id="RegionServicePlanBody">
                        <div class="_input-group _input-date-group">
                            <div class="form-row" data-before="计划周期：">
                                <div class="form-group col-md-4">
                                    <input type="text" class="form-control form-control-sm" id="datetimeStart" placeholder="开始日期" name="start_date">
                                </div>至
                                <div class="form-group col-md-4">
                                    <input type="text" class="form-control form-control-sm" id="datetimeEnd" placeholder="结束日期" name="end_date">
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="<?=base_url()?>media/wePlatForm/js/bootstrap-datetimepicker.min.js"></script>
    <script>
        ...
        (function() {
            ...
            $('#region_service_plan_modal').on('shown.bs.modal', function () {
                ...
                $.ajax({
                    type: "GET",
                    url: '<?=anchorurl('regions/getRegionBusinessServicePlanInfo')?>/'+service_plan_id,
                    beforeSend:function(){
    ...
    <script type="text/javascript" src="<?=base_url()?>media/wePlatForm/js/region_service_plan.js"></script>
</body>
</html>
