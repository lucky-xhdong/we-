<div class="_input-group">
    <div class="form-row" data-before="计划名称：">
        <div class="form-group col-md-8">
            <input type="text" class="form-control form-control-sm" value="<?php if(isset($regionServicePlan->id)) echo $regionServicePlan->name;?>" placeholder="计划名称" name="name" required>
        </div>
    </div>
</div>
<div class="_input-group">
    <div class="form-row" data-before="计划介绍：">
        <div class="form-group col-md-8">
            <textarea type="text" class="form-control form-control-sm" placeholder="计划介绍" name="description"><?php if(isset($regionServicePlan->id)) echo $regionServicePlan->description;?></textarea>
        </div>
    </div>
</div>
<div class="_input-group">
        ...
        <div class="form-group col-md-3">
            <select class="form-control form-control-sm" placeholder="学校" name="school_id">
                ...
                <?php foreach($schools as $school):?>
                    <?php if(isset($regionServicePlan->id) && $school->id == $regionServicePlan->school_id):?>
