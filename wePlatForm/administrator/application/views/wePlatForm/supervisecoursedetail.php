        ...
        <div class="col-md-9 ct--main-wrapper">
            ...
            <nav class="common-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <?php if(isset($viewSuperviseCourse) && $viewSuperviseCourse === true):?>
                        <li class="breadcrumb-item"><a href="<?=anchorurl("supervisecourselist/")?>">督课列表</a></li>
                        <li class="breadcrumb-item active" aria-current="page">督课表详情</li>
                    <?php else:?>
                    ...
                    <div class="card ct--main__basic">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body row">
                                <div class="col-6 ct--main__basic_item" data-before="区域："><?=$region->name?></div>
                                <div class="col-6 ct--main__basic_item" data-before="学 校："><?=$superviseCourseDetail['schoolInfo']->name?></div>
                                <div class="col-6 ct--main__basic_item" data-before="班 级："><?=$superviseCourseDetail['classInfo']->name?></div>
                                <div class="col-6 ct--main__basic_item" data-before="教师："><?=$superviseCourseDetail['teacherInfo']->name?></div>
                                <div class="col-6 ct--main__basic_item" data-before="督课日期："><?=date("Y-m-d",strtotime($SuperviseCourse->created_time))?></div>
