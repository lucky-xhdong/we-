        ...
        <div class="col-md-9 ct--main-wrapper">
            ...
            <nav class="common-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?=anchorurl("/serviceaudit/business/")?>">商务计划审核</a></li>
...
<!--                                <div class="col-6 ct--main__basic_item" data-before="查看附件：">点击下载附件</div>-->
    ...
    <script type="text/javascript" src="<?=base_url()?>media/wePlatForm/js/region_service_audit_plan.js"></script>
</body>
</html>
