    ...
    <div class="col-md-9 ra--main-wrapper">
      ...
      <div class="ra--main__content" data-before="教学进度列表（总）">
        ...
        <div class="btn-group-end">
          <a href="javascript:;"  class="btn btn-outline-primary btn-sm"  data-toggle="modal" data-target="#materia_resources_modal">
            创建教学进度
          </a>
        </div>
...
<script type="text/javascript" src="<?=base_url()?>media/wePlatForm/js/teachingschedules.js"></script>
