...
<div class="container-fluid ClassTimetable">
                    ...
                    <div class="card ct--main__basic">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body row">
                                ...
                                <div class="col-6 ct--main__basic_item" data-before="上传时间："><?=$region_education_plan->getUserInfo()->created_time?></div>
    ...
    <script type="text/javascript" src="<?=base_url()?>media/wePlatForm/js/supervisecourses.js"></script>
</body>
</html>
