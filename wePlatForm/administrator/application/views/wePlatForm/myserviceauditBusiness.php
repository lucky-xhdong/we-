        ...
        <div class="col-md-9 fm--main-wrapper">
            ...
            <nav class="common-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">商务计划</li>
                </ol>
            </nav>
            <!--面包屑 end-->
            <!--主体内容 start-->
            <div class="fm--main__content" data-before="商务计划">
                <!--选项卡标签 start-->
...
<!--                                </a>-->
<!--                            </div>-->
                            <div id="paginator_region_service_plan">
    ...
    <div class="modal fade commonModal" id="audie_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?=anchorurl('serviceaudit/addRegionServicePlan/')?>" id="plan_form" class="form-group needs-validation" novalidate method="post">
    ...
    <div class="modal fade commonModal" id="region_service_plan_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?=anchorurl('regions/addRegionServicePlan/0')?>" id="region_service_plan_form" class="form-group needs-validation" novalidate method="post">
    ...
    <script>
        ...
        $(document).ready(function () {
            getServicePlanmmgDocument(<?=getAdminViewer()->id?>);
            ...
            $(".status").click(function(){
                if($(this).is(":checked")){
                    mmgservicepLANDocument.load({status:$(this).val()});
                }
            });
            ...
            $('#region_service_plan_modal').on('shown.bs.modal', function () {
                ...
                $.ajax({
                    type: "GET",
                    url: '<?=anchorurl('regions/getRegionServicePlanInfo')?>/'+service_plan_id,
                    beforeSend:function(){
