...
<div class="container-fluid ClassTimetable">
        ...
        <div class="col-md-9 ct--main-wrapper">
            ...
            <nav class="common-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?=anchorurl("/serviceaudit/operate/")?>">运营计划审核</a></li>
    ...
    <script type="text/javascript" src="<?=base_url()?>media/wePlatForm/js/region_operate_audit_plan.js"></script>
</body>
</html>
