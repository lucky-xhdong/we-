...
<div class="container-fluid ClassTimetable">
        ...
        <div class="col-md-9 ct--main-wrapper">
            ...
            <nav class="common-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:;">教学计划</a></li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">区域教学计划</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?=anchorurl('regions/addRegionServiceEducationPlan/'.$plan_detail->id)?>" id="region_service_plan_form" class="form-group needs-validation" novalidate method="post">
    ...
    <script type="text/javascript" src="<?=base_url()?>media/wePlatForm/js/region_education_plan.js"></script>
</body>
</html>
