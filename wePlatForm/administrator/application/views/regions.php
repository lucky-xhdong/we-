  ...
  <div id="content" class="app-content" role="main">
    <div class="app-content-body ">
      <div class="bg-light lter b-b wrapper-md" style="height: auto">
        <div class="col-md-8">
          <p>
            <a href="<?=anchorurl('regions')?>">区域管理</a><span>&nbsp;&nbsp;</span>
          </p>
        </div>
        <div class="col-md-4">
...
<!--新建 开始-->
  <div class="modal fade new-icon-box" role="dialog">
    <div class="modal-dialog">
      <?php echo form_open('regions/addRegion', 'class="form login-form" id="region-form"'); ?>
      <div class="modal-content">
            ...
            <div class="text-center basic-info pag-15 minH-200">
              <ul>
                ...
                <li class="col-md-12">
                  ...
                  <div class="col-md-8">
                    <label for="" ><input name="name" type="text" placeholder="区域名称" required/></label>
                  </div>
                </li>
                <li class="col-md-12">
        ...
        <div class="modal-footer text-center">
          ...
          <button type="button" class="btn btn-success" id="createRegion">完成</button>
        </div>
      </div>
      <?php echo form_close(); ?>
    </div>
...
<!--基本设置 开始-->
  <div class="modal fade setting-icon-box modal-nor" data-type = 1  role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <?php echo form_open('regions/addRegion', 'class="form login-form" id="region-edit-form"'); ?>
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        </div>
        <div class="modal-body">
...
<!--授权时间 开始-->
  <div class="modal fade give-time-icon-box modal-nor"  role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <?php echo form_open('regions/setRegionHomeAuthTime', 'class="form login-form" id="set-school-auth-form"'); ?>
        ...
        <div class="modal-footer text-center type-hide">
          <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal" data-type="hide">取消</button>
          <button type="button" class="btn btn-success" id="submitRegionTime">保存</button>
        </div>
        <?php echo form_close(); ?>
      </div>
    </div>
...
<a href="#" class="btn btn-info setting-icon" id="region_settings" style="display: none">
  基本设置
</a>
...
<script type="text/javascript" src="<?=base_url()?>media/administrator/js/region.js"></script>
<script>
  var userItem = null;
  $(function() {
