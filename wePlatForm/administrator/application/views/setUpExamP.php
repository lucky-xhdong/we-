      ...
      <div class="hbox hbox-auto-xs hbox-auto-sm" >
        <div class="col">
          ...
          <div class="text-center setting-exap-time">
            <span>目前设置的考试时间为：<i><?=$time?></i>分钟 </span>
            <span>考试分数 <i><?=$score?></i>分 </span>
          </div>
          <div class="wrapper-md">
            <div class="panel panel-default">
              ...
              <div class="ques-model">
                ...
                <div class="clearfix pagh-5">
                  <div class="col-sm-1 text-right">
                    <a class="text-info add-new-ques-model">添加新模块</a>
                  </div>
                </div>
                <div class="clearfix text-center">
<!--                  <button class="btn-success exam-prev-btn">预览</button>-->
                  <a class="btn-success exam-issue-btn" href="<?=site_url('home/examinationPaper')?>">发布</a>
                </div>
              </div>
            </div>
          </div>
...
<script>
    $(function () {
        $(".exam-issue-btn").on('click',function () {
   ...
   //选择试题
        ...
        //添加小节
        $("body").delegate('.add-new-section','click',function () {
            var select = "<select name='section_skill'>";
            <?php foreach($skill as $key=>$value): ?>
            select+="<option value='<?=$value->id?>'><?=$value->skill_name?></option>"
            <? endforeach;?>
            select+="</select>"
            var section_con = $(".section_con");
            var new_section = "<div class='bg-f8fdf8 pag-15 new-section' style='margin-bottom: 10px;'>"
                +"<div class='clearfix mgb-10 pagh-5 '>"
                +"<div class='col-sm-1 text-right'>小节名称:</div>"
                +"<div class='col-sm-2'>"
                +"<input type='text' name='section_name' class='input-h26'>"
                +"</div>"
                +"<div class='col-sm-1'>"
                ...
                +"</div>"
                +"<div class='clearfix mgb-10 pagh-5 '>"
                +"<div class='col-sm-1 text-right'>小节类型:</div>"
                +"<div class='col-sm-2'>"
                + select
                +"</div>"
                +"<div class='col-sm-1'>"
                ...
                +"<div class='col-sm-11'>"
                +"<div class='bor-all-999'><input style='width: 100%;' name='answer' placeholder='输入内容区域'/></div>"
                +"</div>"
                +"</div>"
                ...
                +"</div>"
                +"</div>";
            section_con.append(new_section)
        });
        //删除小节
        $("body").delegate(".del-new-section",'click',function () {
            $(this).parents('.new-section').remove();
        });
        //新建模板
        $('.add-new-ques-model').on('click',function () {
            var model = $('.ques-model');
            ...
            var select = "<select name='skill'>";
                ...
                <? endforeach;?>
                select+="</select>";
            var section_select = "<select name='section_skill'>";
            <?php foreach($skill as $key=>$value): ?>
                section_select+="<option value='<?=$value->id?>'><?=$value->skill_name?></option>"
            <? endforeach;?>
            ...
            +"<div class='col-sm-2'>"
            +"<input type='text' value='' name='model_name' class='input-h26'>"
            +"</div>"
            +"<div class='col-sm-1'>"
            ...
            +"<input type='text' value='' name='model_time'  class='exam-cont-time input-h26' >"
            +"</div>"
            +"</div>"
            +"</div>"
            +"<div class='section_con'>"
            +"<div class='bg-f8fdf8 pag-15 new-section' style='margin-bottom: 10px'>"
            +"<div class='clearfix mgb-10 pagh-5 '>"
            +"<div class='col-sm-1 text-right'>小节名称:</div>"
            +"<div class='col-sm-2'>"
            +"<input type='text' name='section_name' class='input-h26'>"
            ...
            +"<div class='clearfix pagh-5'>"
            +"<div class='col-sm-1 text-right'>"
            +"<a class='text-info add-new-ques-model add-new-section'>添加小节</a>"
            +"</div></div>"
//            +"<div class='bor-ccc pag-15'><div class='ques-item'></div><div class='clearfix pagh-5 one-item'><div class='col-sm-1 text-right'>"
//            +"<a href='javascript:;' class='text-info add-new-section'>添加小节</a></div></div></div>"
            +"<div class='clearfix text-center'>"
            +"<button class=' btn-info exam-save-btn' data-modelid=''>保存</button>"
            +"</div>"
            +"</div>";
        model.append(new_model);
        });
        //新建模板试题
        $('body').delegate('.add-new-ques-item','click',function () {
            var ques_them = true;
            $('.ques_them').each(function (index) {
                if($(this).text()==''){
                    ques_them = false;
            ...
            if($('.ques_them').length==0||($('.ques_them').length>0 && ques_id && ques_them)){
                var item = $(this).parents('.one-item').siblings(".ques-item");
                var select = "<select name='type'>";
                <?php foreach($type as $key=>$value): ?>
                select+="<option value='<?=$value->id?>'><?=$value->question_type?></option>"
                <? endforeach;?>
                select+="</select>"
                var new_item =
                    ...
                    +"<div class='col-sm-6'>"
                    +"<ul class='theme-list'>"
                    +"<li>主题：<span class='ques_them'></span> <span class='theme-type'>编号：<span class='ques_id'></span></span></li>"
                    +"</ul>"
                    +"<div class='col-sm-4' style='padding-left:0;'><button class='btn-success sel-h26 text-center btn-change-exam' data-toggle='modal' data-target='#choose-exam-box'>选择</button></div>"
                    +"</div>"
                    +"</div>"
                    +"<div class='clearfix mgb-10 pagh-5'>"
                    +"<div class='col-sm-1 text-right'>考试时间</div>"
                    +"<div class='col-sm-2 exam-cont-time' data-name='分钟'>"
                    +"<input type='text' value='' name='ques_time' class='input-h26' >"
                    +"</div>"
                    +"</div>"
                    +"<div class='clearfix mgb-10 pagh-5'>"
                    +"<div class='col-sm-1 text-right'>每题分数</div>"
                    +"<div class='col-sm-2 exam-cont-time' data-name='分'>"
                    +"<input value='' class='input-h26' name='ques_score' type='text'>"
                    +"</div>"
        ...
        //删除模块
        $('body').delegate('.del-model','click',function () {
            $(this).parents('.del-model-name').remove();
        });
        //删除问题
        $('body').delegate('.del-ques','click',function () {
           $(this).parents('.del-ques-name').remove();
        });
...
//            发送异步请求传输问题
        ...
        $('body').delegate('.exam-save-btn','click',function () {
            ...
            $(this).parents('.del-model-name').find(".new-section").each(function () {
                ...
                section_obj.section_skill = $(this).find("select[name='section_skill']").val();
