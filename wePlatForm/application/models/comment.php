...
class Comment extends CI_Model
{
	...
	public function  getCommentInfo(){
		...
		if(isset($this->id)){
			$data = array(
				...
				'toUserInfo'    => !empty($this->to_user_id)?$this->user->getUser($this->to_user_id)->getUserInfoNotToken():array(),
			);
		}
		return $data;
	}
	...
	public function addComment($data=array(),$user=null,$to_user=null){
		if($this->_minxer && count($data) && $user){
