...
class Home extends CI_Controller {
    ...
    {
        $data['touTiaoArticles']  = $this->category->getArticlesForList(76,0,3);
        $data['peopleArticles']  = $this->category->getArticlesForList(77,0,2);
        ...
        $data['teacherarticles']  = $this->category->getArticlesForList(79,0,1);
        $data['techrticles']  = $this->category->getArticlesForList(80,0,1);
        $data['foreignTeacherArticles']  = $this->category->getArticlesForList(81,0,1);
    ...
    public function report(){
        $this->load->view('wePlatForm1.0.0/report');
    }
}
