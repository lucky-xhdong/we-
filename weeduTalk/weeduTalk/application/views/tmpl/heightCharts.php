<link rel="stylesheet" href="<?=base_url()?>media/administrator/heightchart/css/highcharts.css" type="text/css" />
...
<script type="text/javascript" src="<?=base_url()?>media/administrator/js/basichighchatapp.js"></script>