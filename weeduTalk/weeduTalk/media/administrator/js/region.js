...
var tItem = [
    ...
    },
    {
        ...
        lockDisplay: true,
        renderer: function (val) {
            return '<button  class="btn btn-primary"> 更换背景</button> <button  class="btn btn-warning"> 停用/恢复</button> <button  class="btn btn-success">授权时间</button> <button  class="btn btn-info">编辑</button> <button  class="btn btn-danger">删除</button>'
        }
    }
