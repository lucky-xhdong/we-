...
var tItem = [
    ...
    },
    {
        ...
        renderer:function(val,item){
            return '<a href="'+base_url+'/publishing_houses/getCourseUnit/'+item.publishing_house_course_id+'">'+val+'</a>'
        }
    },
    {
        title:'排序',
...
function sortEventList(){
    $("#mmGrid tbody").sortable({
        ...
        update: function() {
            ...
            $.ajax({
                url: base_url+'/publishing_houses/updateCourseSorts/'+publishing_house_id,
                type : "post",
                data :{
...
var mmg = $('#mmGrid').mmGrid({
    ...
    height: 'auto',
    cols: tItem,
    url: base_url+'/publishing_houses/getPublishingHouseCourseList/'+publishing_house_id,
    method: 'get',
    params:{
